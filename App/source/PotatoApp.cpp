...
#include <PotatoApp/Editor/Editor.h>
...
void PotatoApp::recreateSwapChain()
{
    int width = 0;
    int height = 0;
...
void PotatoApp::cleanupSwapChain()
{
...
void PotatoApp::createInstance()
{
    ...
    appInfo.pEngineName = "Potato Engine";
...
bool PotatoApp::checkValidationLayerSupport()
{
    uint32_t layerCount;
...
std::vector<const char*> PotatoApp::getRequiredExtensions() const 
{
...
void PotatoApp::setupDebugMessenger()
{
    if (!enableValidationLayers)
    {
        return;
...
void PotatoApp::populateDebugMessengerCreateInfo(VkDebugUtilsMessengerCreateInfoEXT& createInfo)
{
    createInfo = {};
...
VkResult PotatoApp::createDebugUtilsMessengerEXT(VkInstance instance, const VkDebugUtilsMessengerCreateInfoEXT* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkDebugUtilsMessengerEXT* pDebugMessenger)
{
...
void PotatoApp::destroyDebugUtilsMessengerEXT(VkInstance instance, VkDebugUtilsMessengerEXT debugMessenger, const VkAllocationCallbacks* pAllocator)
{
...
void PotatoApp::pickPhysicalDevice()
{
...
bool PotatoApp::isDeviceSuitable(VkPhysicalDevice device)
{
...
bool PotatoApp::checkDeviceExtensionSupport(VkPhysicalDevice device)
{
...
QueueFamilyIndices PotatoApp::findQueueFamilies(VkPhysicalDevice device)
{
...
SwapChainSupportDetails PotatoApp::querySwapChainSupport(VkPhysicalDevice device)
{
...
void PotatoApp::createLogicalDevice()
{
...
void PotatoApp::createSwapChain()
{
...
VkSurfaceFormatKHR PotatoApp::chooseSwapSurfaceFormat(const std::vector<VkSurfaceFormatKHR>& availableFormats)
{
...
VkPresentModeKHR PotatoApp::chooseSwapPresentMode(const std::vector<VkPresentModeKHR>& availablePresentModes)
{
...
VkExtent2D PotatoApp::chooseSwapExtent(const VkSurfaceCapabilitiesKHR& capabilities)
{
...
void PotatoApp::createImageViews()
{
...
void PotatoApp::createRenderPass()
{
...
void PotatoApp::createDescriptorSetLayout()
{
...
void PotatoApp::createGraphicsPipeline()
{
...
VkShaderModule PotatoApp::createShaderModule(const std::vector<char>& code)
{
...
void PotatoApp::createFramebuffers()
{
...
void PotatoApp::createCommandPool()
{
...
void PotatoApp::createBuffer(VkDeviceSize size, VkBufferUsageFlags usage, VkMemoryPropertyFlags properties, VkBuffer& buffer, VkDeviceMemory& bufferMemory)
{
...
void PotatoApp::copyBuffer(VkBuffer srcBuffer, VkBuffer dstBuffer, VkDeviceSize size)
{
...
void PotatoApp::createDepthResources()
{
...
void PotatoApp::createTextureImage()
{
...
void PotatoApp::createImage(uint32_t width, uint32_t height, uint32_t mipLevels, VkSampleCountFlagBits numSamples, VkFormat format, VkImageTiling tiling, VkImageUsageFlags usage, VkMemoryPropertyFlags properties, VkImage& image, VkDeviceMemory& imageMemory)
{
...
VkImageView PotatoApp::createImageView(VkImage image, VkFormat format, VkImageAspectFlags aspectFlags, uint32_t mipLevels)
{
...
void PotatoApp::transitionImageLayout(VkImage image, VkFormat format, VkImageLayout oldLayout, VkImageLayout newLayout, uint32_t mipLevels)
{
    VkCommandBuffer commandBuffer = beginSingleTimeCommands();
...
void PotatoApp::copyBufferToImage(VkBuffer buffer, VkImage image, uint32_t width, uint32_t height)
{
    VkCommandBuffer commandBuffer = beginSingleTimeCommands();
...
VkCommandBuffer PotatoApp::beginSingleTimeCommands()
{
...
void PotatoApp::endSingleTimeCommands(VkCommandBuffer commandBuffer)
{
...
void PotatoApp::createVertexBuffer()
{
...
void PotatoApp::createIndexBuffer()
{
...
void PotatoApp::createUniformBuffers()
{
...
void PotatoApp::createDescriptorPool()
{
...
void PotatoApp::createDescriptorSets()
{
...
uint32_t PotatoApp::findMemoryType(uint32_t typeFilter, VkMemoryPropertyFlags properties)
{
...
void PotatoApp::createCommandBuffers() 
{
...
void PotatoApp::createSyncObjects()
{
...
void PotatoApp::updateUniformBuffer(uint32_t currentImage)
{
...
VkFormat PotatoApp::findSupportedFormat(const std::vector<VkFormat>& candidates, VkImageTiling tiling, VkFormatFeatureFlags features)
{
...
VkFormat PotatoApp::findDepthFormat()
{
...
bool PotatoApp::hasStencilComponent(VkFormat format)
{
    return format == VK_FORMAT_D32_SFLOAT_S8_UINT || format == VK_FORMAT_D24_UNORM_S8_UINT;
}

void PotatoApp::loadModel()
{
...
void PotatoApp::generateMipmaps(VkImage image, VkFormat imageFormat, int32_t texWidth, int32_t texHeight, uint32_t mipLevels)
{
...
VkSampleCountFlagBits PotatoApp::getMaxUsableSampleCount()
{
...
void PotatoApp::createColorResources()
{
